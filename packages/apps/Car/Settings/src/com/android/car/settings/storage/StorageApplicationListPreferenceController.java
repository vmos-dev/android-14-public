...
public class StorageApplicationListPreferenceController extends
    ...
    protected Preference createPreference(String title, String summary, Drawable icon,
            String key, ApplicationsState.AppEntry appEntry) {
        ...
        preference.setOnPreferenceClickListener(p -> {
            AppStorageSettingsDetailsFragment mAppStorageSettingsDetailFragment = AppStorageSettingsDetailsFragment.getInstance(key);
            mAppStorageSettingsDetailFragment.setAppEntry(appEntry);
            getFragmentController().launchFragment(mAppStorageSettingsDetailFragment);
            return true;
        });
        return preference;
    }
