...
public class PinnedAppListViewModel extends AndroidViewModel {
    ...
    private PinnedAppListLiveData mLiveData;
    ...
    public LiveData<List<AppEntry>> getPinnedAppList(int assignedUserId) {
        mLiveData = new PinnedAppListLiveData(mApplication, assignedUserId);
        return mLiveData;
    }
}
