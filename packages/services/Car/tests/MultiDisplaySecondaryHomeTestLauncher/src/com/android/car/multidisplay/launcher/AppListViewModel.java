...
public class AppListViewModel extends AndroidViewModel {
    ...
    private AppListLiveData mLiveData;
    ...
    public LiveData<List<AppEntry>> getAppList(int assignedUserId) {
        mLiveData = new AppListLiveData(mApplication, assignedUserId);
        getApplication().unregisterReceiver(mPackageIntentReceiver);
        mPackageIntentReceiver = new PackageIntentReceiver(mLiveData, mApplication);
        return mLiveData;
    }
