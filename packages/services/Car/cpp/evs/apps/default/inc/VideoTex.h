...
#if RKAVM
    bool refreshGraphicBuffer();
    android::sp<android::GraphicBuffer> myBuffer = nullptr;
    BufferDesc mImageBufferDup;
    //const BufferDesc& getCurBufDesc(){return mImageBuffer;}
#endif
