...
int rk_avm_get_fbo_fd(int index);
...
bool rk_avm_render_update_android_tex(int camId, const native_handle_t *inHandle, android::GraphicBuffer::HandleWrapMethod method, uint32_t inWidth,
                                      ...
                                      uint32_t inStride);
bool rk_avm_render_update_android_graphicbuffer(int camId, android::GraphicBuffer* gbuffer);
bool rk_avm_render_update_android_graphicbuffer(int camId, buffer_handle_t handle, const AHardwareBuffer_Desc* pDesc);
bool rk_avm_render_update_android_graphicbuffer_nomap(int camId, buffer_handle_t handle, android::sp<android::GraphicBuffer> &inputbuffer);
...
int rk_avm_get_render_out_width();
int rk_avm_get_render_out_height();
int rk_avm_get_evs_fd(int index);
void rk_avm_set_display(int dw, int dh);
void rk_avm_destroy_shader();
buffer_handle_t rk_avm_get_native_handle(int index);
