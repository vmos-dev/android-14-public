...
#ifndef HARDWARE_INTERFACES_CAMERA_PROVIDER_DEFAULT_VIRTUALPROVIDER_H_
#define HARDWARE_INTERFACES_CAMERA_PROVIDER_DEFAULT_VIRTUALPROVIDER_H_
...
class VirtualProvider : public BnCameraProvider {
  public:
    VirtualProvider();
    ~VirtualProvider() override;
  ...
  private:
    void addVritual(const char* devName);
    ...
    // This thread calls back into VirtualProvider when an actionable change is detected.
    class HotplugThread : public SimpleThread {
      public:
        explicit HotplugThread(VirtualProvider* parent);
      ...
      private:
        ...
        VirtualProvider* mParent = nullptr;
...
#endif  // HARDWARE_INTERFACES_CAMERA_PROVIDER_DEFAULT_VIRTUALPROVIDER_H_
