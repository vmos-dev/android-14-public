...
struct HwCamera {
    ...
    virtual sp<CameraModule> getModule() const = 0;
    virtual camera3_device_t* getDevice() const = 0;
    virtual void setDevice(camera3_device_t* device) = 0;
    virtual std::vector<StreamBuffer> getOutputStreamBuffer(HwCaptureRequest req,int streamId) = 0;
};
