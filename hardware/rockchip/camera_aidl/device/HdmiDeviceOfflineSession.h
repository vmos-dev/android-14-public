...
#ifndef HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIDEVICEOFFLINESESSION_H_
#define HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIDEVICEOFFLINESESSION_H_
...
class HdmiDeviceOfflineSession final : public BnCameraOfflineSession,
                                           public virtual RefBase,
                                           public virtual OutputThreadInterface {
  public:
    HdmiDeviceOfflineSession(const CroppingType& croppingType,
    ...
    ~HdmiDeviceOfflineSession() override;
  ...
  private:
    class OutputThread : public HdmiDeviceSession::OutputThread {
      public:
        OutputThread(std::weak_ptr<OutputThreadInterface> parent, CroppingType ct,
                     const common::V1_0::helper::CameraMetadata& chars,
                     std::shared_ptr<HdmiDeviceSession::BufferRequestThread> bufReqThread,
                     std::deque<std::shared_ptr<HalRequest>>& offlineReqs)
            : HdmiDeviceSession::OutputThread(std::move(parent), ct, chars,
    ...
    std::shared_ptr<HdmiDeviceSession::BufferRequestThread> mBufferRequestThread;
...
#endif  // HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_HDMIDEVICEOFFLINESESSION_H_
