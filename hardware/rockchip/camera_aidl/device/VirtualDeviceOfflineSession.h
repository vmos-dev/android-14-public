...
#ifndef HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALDEVICEOFFLINESESSION_H_
#define HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALDEVICEOFFLINESESSION_H_
...
class VirtualDeviceOfflineSession final : public BnCameraOfflineSession,
                                           public virtual RefBase,
                                           public virtual OutputThreadInterface {
  public:
    VirtualDeviceOfflineSession(const CroppingType& croppingType,
    ...
    ~VirtualDeviceOfflineSession() override;
  ...
  private:
    class OutputThread : public VirtualDeviceSession::OutputThread {
      public:
        OutputThread(std::weak_ptr<OutputThreadInterface> parent, CroppingType ct,
                     const common::V1_0::helper::CameraMetadata& chars,
                     std::shared_ptr<VirtualDeviceSession::BufferRequestThread> bufReqThread,
                     std::deque<std::shared_ptr<HalRequest>>& offlineReqs)
            : VirtualDeviceSession::OutputThread(std::move(parent), ct, chars,
    ...
    std::shared_ptr<VirtualDeviceSession::BufferRequestThread> mBufferRequestThread;
...
#endif  // HARDWARE_INTERFACES_CAMERA_DEVICE_DEFAULT_VIRTUALDEVICEOFFLINESESSION_H_
