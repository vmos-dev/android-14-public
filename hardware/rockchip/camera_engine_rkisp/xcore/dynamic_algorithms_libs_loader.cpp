...
#ifdef XCAM_LIB64
#define XCAM_DEFAULT_3A_LIB_DIR "/vendor/lib64/rkisp/3a"
#define XCAM_DEFAULT_AE_LIB_DIR "/vendor/lib64/rkisp/ae"
#define XCAM_DEFAULT_AWB_LIB_DIR "/vendor/lib64/rkisp/awb"
#define XCAM_DEFAULT_AF_LIB_DIR "/vendor/lib64/rkisp/af"

#define XCAM_SECOND_3A_LIB_DIR "/vendor/lib/rkisp/3a"
#define XCAM_SECOND_AE_LIB_DIR "/vendor/lib/rkisp/ae"
#define XCAM_SECOND_AWB_LIB_DIR "/vendor/lib/rkisp/awb"
#define XCAM_SECOND_AF_LIB_DIR "/vendor/lib/rkisp/af"
#else
...
#define XCAM_SECOND_3A_LIB_DIR "/vendor/lib64/rkisp/3a"
#define XCAM_SECOND_AE_LIB_DIR "/vendor/lib64/rkisp/ae"
#define XCAM_SECOND_AWB_LIB_DIR "/vendor/lib64/rkisp/awb"
#define XCAM_SECOND_AF_LIB_DIR "/vendor/lib64/rkisp/af"
#endif
#else
...
X3aHandlerManager::find_handler ()
{
    ...
    if (dir_3a) {
        while ((dirent_3a = readdir (dir_3a)) != NULL) {
            ...
            if (_ae_handler == NULL) {
                dir_path = XCAM_SECOND_AE_LIB_DIR;
                XCAM_LOG_INFO ("doesn't find XCAM_DEFAULT_AE_LIB_DIR, change to dir:%s", dir_path);
                snprintf (lib_path, sizeof(lib_path), "%s/%s", dir_path, dirent_3a->d_name);
                _ae_handler = (XCamAEDescription*)load_handler_from_binary (lib_path, XCAM_HANDLER_AE);
            }
        }
    ...
    if (dir_3a) {
        ...
        if (_awb_handler == NULL) {
            dir_path = XCAM_SECOND_AWB_LIB_DIR;
            XCAM_LOG_INFO ("doesn't find XCAM_DEFAULT_AWB_LIB_DIR, change to dir:%s", dir_path);
            snprintf (lib_path, sizeof(lib_path), "%s/%s", dir_path, dirent_3a->d_name);
            _awb_handler = (XCamAWBDescription*)load_handler_from_binary (lib_path, XCAM_HANDLER_AWB);
        }
    ...
    if (dir_3a) {
        while ((dirent_3a = readdir (dir_3a)) != NULL) {
            ...
            if (_af_handler == NULL) {
                dir_path = XCAM_SECOND_AF_LIB_DIR;
                XCAM_LOG_INFO ("doesn't find XCAM_DEFAULT_AF_LIB_DIR, change to dir:%s", dir_path);
                snprintf (lib_path, sizeof(lib_path), "%s/%s", dir_path, dirent_3a->d_name);
                _af_handler = (XCamAFDescription*)load_handler_from_binary (lib_path, XCAM_HANDLER_AF);
            }
        }
