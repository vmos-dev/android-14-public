...
#define PB_FIELD(tag, type, rules, allocation, placement, message, field,   \
	...
	PB_##rules##_##allocation(tag, message, field,                      \
				  PB_DATAOFFSET_##placement(message, field, \
							    prevfield),     \
...
#define PB_REPEATED_FIXED_COUNT(tag, type, placement, message, field,         \
	...
	{                                                                     \
		tag,                                                          \
			PB_ATYPE_STATIC | PB_HTYPE_REPEATED |                 \
				PB_LTYPE_MAP_##type,                          \
			PB_DATAOFFSET_##placement(message, field, prevfield), \
			0, pb_membersize(message, field[0]),                  \
...
#define PB_ONEOF_STATIC(u, tag, st, m, fd, ltype, ptr)                        \
	{                                                                     \
		tag, PB_ATYPE_STATIC | PB_HTYPE_ONEOF | ltype, fd,            \
			pb_delta(st, which_##u, u.m), pb_membersize(st, u.m), \
			0, ptr                                                \
	}
...
#define PB_ONEOF_FIELD(union_name, tag, type, rules, allocation, placement,  \
	...
	PB_ONEOF_##allocation(union_name, tag, message, field,               \
			      PB_DATAOFFSET_##placement(                     \
				      message, union_name.field, prevfield), \
			      PB_LTYPE_MAP_##type, ptr)

#define PB_ANONYMOUS_ONEOF_STATIC(u, tag, st, m, fd, ltype, ptr)             \
	{                                                                    \
		tag, PB_ATYPE_STATIC | PB_HTYPE_ONEOF | ltype, fd,           \
			pb_delta(st, which_##u, m), pb_membersize(st, m), 0, \
			ptr                                                  \
	}
