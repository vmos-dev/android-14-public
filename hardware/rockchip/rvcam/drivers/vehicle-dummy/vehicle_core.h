...
#define HVAC_LEFT                                                      \
	(VEHICLE_AREA_SEAT_ROW_1_LEFT | VEHICLE_AREA_SEAT_ROW_2_LEFT | \
	 VEHICLE_AREA_SEAT_ROW_2_CENTER)
#define HVAC_RIGHT \
	(VEHICLE_AREA_SEAT_ROW_1_RIGHT | VEHICLE_AREA_SEAT_ROW_2_RIGHT)
...
#define VEHICLE_GEAR_NEUTRAL_CLIENT 1
