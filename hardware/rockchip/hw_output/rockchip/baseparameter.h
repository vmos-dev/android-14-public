...
public:
    ...
    virtual int get_csc_info(struct csc_info *csc) = 0;
    virtual int set_csc_info(struct csc_info *csc) = 0;
    virtual int get_dci_info(struct dci_info *dci) = 0;
    virtual int set_dci_info(struct dci_info *dci) = 0;
    virtual int get_acm_info(struct acm_info *acm) = 0;
    virtual int set_acm_info(struct acm_info *acm) = 0;
    virtual int get_pq_tuning_gamma(struct gamma_lut_data *data) = 0;
    virtual int set_pq_tuning_gamma(struct gamma_lut_data *data) = 0;
    virtual int get_pq_factory_info(struct pq_factory_info *info) = 0;
    virtual int set_pq_factory_info(struct pq_factory_info *info) = 0;
    virtual int get_pq_sharp_info(struct pq_sharp_info *info) = 0;
    virtual int set_pq_sharp_info(struct pq_sharp_info *info) = 0;
    virtual int get_aipq_info(struct aipq_info *info) = 0;
    virtual int set_aipq_info(struct aipq_info *info) = 0;
    virtual int get_version(unsigned short* major_version, unsigned short* minor_version) = 0;
...
public:
    ...
    virtual int get_csc_info(struct csc_info *csc);
    virtual int set_csc_info(struct csc_info *csc);
    virtual int get_dci_info(struct dci_info *dci);
    virtual int set_dci_info(struct dci_info *dci);
    virtual int get_acm_info(struct acm_info *acm);
    virtual int set_acm_info(struct acm_info *acm);
    virtual int get_pq_tuning_gamma(struct gamma_lut_data *data);
    virtual int set_pq_tuning_gamma(struct gamma_lut_data *data);
    virtual int get_pq_factory_info(struct pq_factory_info *info);
    virtual int set_pq_factory_info(struct pq_factory_info *info);
    virtual int get_pq_sharp_info(struct pq_sharp_info *info);
    virtual int set_pq_sharp_info(struct pq_sharp_info *info);
    virtual int get_aipq_info(struct aipq_info *info);
    virtual int set_aipq_info(struct aipq_info *info);
    virtual int get_version(unsigned short* major_version, unsigned short* minor_version);
