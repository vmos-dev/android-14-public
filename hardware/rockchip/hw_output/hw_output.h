...
typedef struct hw_output_device {
	...
	int (*setSWBrightness)(struct hw_output_device* dev,
         int dpy, int bright);

	int (*getSWBrightness)(struct hw_output_device* dev,
		int dpy, int* bright);

	int (*setSWContrast)(struct hw_output_device* dev,
         int dpy, int contrast);

	int (*getSWContrast)(struct hw_output_device* dev,
		int dpy, int* contrast);

	int (*setSWSaturation)(struct hw_output_device* dev,
         int dpy, int saturation);

	int (*getSWSaturation)(struct hw_output_device* dev,
		int dpy, int* saturation);

	int (*setSWHue)(struct hw_output_device* dev,
         int dpy, int hue);

	int (*getSWHue)(struct hw_output_device* dev,
		int dpy, int* hue);

	int (*setRGain)(struct hw_output_device* dev,
         int dpy, int rgain);

	int (*getRGain)(struct hw_output_device* dev,
		int dpy, int* rgain);

	int (*setGGain)(struct hw_output_device* dev,
         int dpy, int ggain);

	int (*getGGain)(struct hw_output_device* dev,
		int dpy, int* ggain);

	int (*setBGain)(struct hw_output_device* dev,
         int dpy, int bgain);

	int (*getBGain)(struct hw_output_device* dev,
		int dpy, int* bgain);

	int (*setCscEnable)(struct hw_output_device* dev,
		bool enable);

	int (*setDciEnable)(struct hw_output_device* dev,
		bool enable);

	int (*setAcmEnable)(struct hw_output_device* dev,
		bool enable);

	int (*setPqEnable)(struct hw_output_device* dev,
		bool enable);

	int (*setBCSHMode)(struct hw_output_device* dev,
		int dpy, int index);

	int (*setWhiteBalanceMode)(struct hw_output_device* dev,
		int dpy, int index);

	int (*setAcmMode)(struct hw_output_device* dev,
		int dpy, int index);

	int (*setDciMode)(struct hw_output_device* dev,
		int dpy, int index);

	int (*setGammaMode)(struct hw_output_device* dev,
		int dpy, int index);

	int (*set3DLutMode)(struct hw_output_device* dev,
		int dpy, int index);

	int (*getBCSHMode)(struct hw_output_device* dev,
		int dpy, int* index);

	int (*getWhiteBalanceMode)(struct hw_output_device* dev,
		int dpy, int* index);

	int (*getAcmMode)(struct hw_output_device* dev,
		int dpy, int* index);

	int (*getDciMode)(struct hw_output_device* dev,
		int dpy, int* index);

	int (*getGammaMode)(struct hw_output_device* dev,
		int dpy, int* index);

	int (*get3DLutMode)(struct hw_output_device* dev,
		int dpy, int* index);

	int (*setPresetBcsh)(struct hw_output_device* dev,
		int dpy, int path, int index, uint32_t brightness,
		uint32_t contrast, uint32_t saturation, uint32_t hue);

	int (*getPresetBcsh)(struct hw_output_device* dev,
		int dpy, int path, int index, uint32_t* brightness,
		uint32_t* contrast, uint32_t* saturation, uint32_t* hue);

	int (*setPresetWhiteBalance)(struct hw_output_device* dev,
		int dpy, int path, int index, uint32_t rgain,
		uint32_t ggain, uint32_t bgain);

	int (*getPresetWhiteBalance)(struct hw_output_device* dev,
		int dpy, int path, int index, uint32_t* rgain,
		uint32_t* ggain, uint32_t* bgain);

	int (*setPresetGamma)(struct hw_output_device* dev,
		int dpy, int path, int index, uint32_t size,
		uint16_t* r, uint16_t* g, uint16_t* b);

	int (*getPresetGamma)(struct hw_output_device* dev,
		int dpy, int path, int index, uint32_t* size,
		uint16_t* r, uint16_t* g, uint16_t* b);

	int (*setPreset3DLut)(struct hw_output_device* dev,
		int dpy, int path, int index, uint32_t size,
		uint16_t* r, uint16_t* g, uint16_t* b);

	int (*getPreset3DLut)(struct hw_output_device* dev,
		int dpy, int path, int index, uint32_t* size,
		uint16_t* r, uint16_t* g, uint16_t* b);

	int (*setWhiteBalance)(struct hw_output_device* dev,
		int dpy, int rgain, int ggain, int bgain);

	int (*set3DLutPath)(struct hw_output_device* dev,
		int dpy, const char* path);

	int (*setSharpEnable)(struct hw_output_device* dev,
		bool enable);

	int (*getSharpMode)(struct hw_output_device* dev,
		int dpy, int* index);

	int (*setSharpMode)(struct hw_output_device* dev,
		int dpy, int index);

	int (*getSharpPeakingGain)(struct hw_output_device* dev,
		int dpy, int* value);

	int (*setSharpPeakingGain)(struct hw_output_device* dev,
		int dpy, int value);

	int (*setAiPqEnable)(struct hw_output_device* dev,
		bool aisd, bool aisr);

	int (*getPqEnable)(struct hw_output_device* dev);

	int (*getCscEnable)(struct hw_output_device* dev);

	int (*getAcmEnable)(struct hw_output_device* dev);

	int (*getDciEnable)(struct hw_output_device* dev);

	int (*getSharpEnable)(struct hw_output_device* dev);

	int (*setHdcpEnable)(struct hw_output_device* dev,
		int dpy, bool enable);

	int (*getHdcpEnableStatus)(struct hw_output_device* dev,
		int dpy, int* status);

	int (*setHdcpType)(struct hw_output_device* dev,
		int dpy, int type);

	int (*getHdcpEncryptedStatus)(struct hw_output_device* dev,
		int dpy, int* status);

	int (*setDviStatus)(struct hw_output_device* dev,
		int dpy, int value);

	int (*getDviStatus)(struct hw_output_device* dev,
		int dpy, int* value);
