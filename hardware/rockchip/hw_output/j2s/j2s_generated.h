#include "pq_setting_config.h"
#include <stdint.h>
#include "j2s.h"

#define J2S_MAGIC 674677843
#define J2S_NUM_OBJ 84
...
static void _j2s_init(j2s_ctx *ctx) {
	...
	obj->offset = (uintptr_t)&((csc*)0)->name;
	obj->elem_size = sizeof(((csc*)0)->name[0]);
	...
	obj->type = J2S_TYPE_STRING;
	obj->flags = 0 | J2S_FLAG_POINTER;
	obj->offset = (uintptr_t)&((dci*)0)->name;
	obj->elem_size = sizeof(((dci*)0)->name[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = 1;
	obj->len_index = -1;
	obj->next_index = 11;
	...
	obj->type = J2S_TYPE_STRING;
	obj->flags = 0 | J2S_FLAG_POINTER;
	obj->offset = (uintptr_t)&((acm*)0)->name;
	obj->elem_size = sizeof(((acm*)0)->name[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = 1;
	obj->len_index = -1;
	obj->next_index = 19;
	...
	obj->type = J2S_TYPE_STRING;
	obj->flags = 0 | J2S_FLAG_POINTER;
	obj->offset = (uintptr_t)&((gamma*)0)->name;
	obj->elem_size = sizeof(((gamma*)0)->name[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = 1;
	obj->len_index = -1;
	obj->next_index = 33;
	...
	obj->type = J2S_TYPE_STRING;
	obj->flags = 0 | J2S_FLAG_POINTER;
	obj->offset = (uintptr_t)&((sharp*)0)->name;
	obj->elem_size = sizeof(((sharp*)0)->name[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = 1;
	obj->len_index = -1;
	obj->next_index = 38;
	...
	obj->elem_size = sizeof(((pq_tuning_param*)0)->csc[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = (sizeof(((pq_tuning_param*)0)->csc) / obj->elem_size);
	obj->len_index = -1;
	obj->next_index = 79;
	obj->struct_index = 0;
	obj->enum_index = -1;
	...
	obj->elem_size = sizeof(((pq_tuning_param*)0)->dci[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = (sizeof(((pq_tuning_param*)0)->dci) / obj->elem_size);
	obj->len_index = -1;
	obj->next_index = 80;
	obj->struct_index = 1;
	obj->enum_index = -1;
	...
	obj->elem_size = sizeof(((pq_tuning_param*)0)->acm[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = (sizeof(((pq_tuning_param*)0)->acm) / obj->elem_size);
	obj->len_index = -1;
	obj->next_index = 81;
	obj->struct_index = 2;
	obj->enum_index = -1;
	...
	obj->elem_size = sizeof(((pq_tuning_param*)0)->gamma[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = (sizeof(((pq_tuning_param*)0)->gamma) / obj->elem_size);
	obj->len_index = -1;
	obj->next_index = 82;
	obj->struct_index = 3;
	obj->enum_index = -1;
	...
	obj->elem_size = sizeof(((pq_tuning_param*)0)->sharp[0]);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = (sizeof(((pq_tuning_param*)0)->sharp) / obj->elem_size);
	obj->len_index = -1;
	obj->next_index = -1;
	obj->struct_index = 4;
	obj->enum_index = -1;
	...
	obj->type = J2S_TYPE_STRUCT;
	obj->flags = 0 ;
	obj->offset = (uintptr_t)&((pq_setting_config*)0)->pq_tuning_param;
	obj->elem_size = sizeof(((pq_setting_config*)0)->pq_tuning_param);
	obj->base_elem_size = obj->elem_size;
	obj->num_elem = 1;
	obj->len_index = -1;
	obj->next_index = -1;
	...
	ctx->structs[1].child_index = 10;
	strcpy(ctx->structs[2].name, "acm");
	ctx->structs[2].child_index = 18;
	strcpy(ctx->structs[3].name, "gamma");
	ctx->structs[3].child_index = 32;
	strcpy(ctx->structs[4].name, "sharp");
	ctx->structs[4].child_index = 37;
	strcpy(ctx->structs[5].name, "pq_tuning_param");
	ctx->structs[5].child_index = 78;
	strcpy(ctx->structs[6].name, "pq_setting_config");
	ctx->structs[6].child_index = 83;
}
